...
class  BinaryConversion extends JInternalFrame
{
    private static  BinaryConversion instance = null;
    ...
    public static  BinaryConversion getInstance() {
        if(instance == null) {
            instance = new  BinaryConversion();
        }
        return instance;
    }
    ...
    public void convert(){
        try {
            ...
            lbl2.setText("Binary number: " + str);
        }
        catch(Exception e) {
